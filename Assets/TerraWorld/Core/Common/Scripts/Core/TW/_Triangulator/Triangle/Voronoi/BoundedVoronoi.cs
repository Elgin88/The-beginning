...
namespace TerraUnity.TriangleNet.Voronoi
{
    using System.Collections.Generic;
    using TerraUnity.TriangleNet.Geometry;
    using TerraUnity.TriangleNet.Tools;
    using TerraUnity.TriangleNet.Topology.DCEL;

    using HVertex = TerraUnity.TriangleNet.Topology.DCEL.Vertex;
    using TVertex = TerraUnity.TriangleNet.Geometry.Vertex;
