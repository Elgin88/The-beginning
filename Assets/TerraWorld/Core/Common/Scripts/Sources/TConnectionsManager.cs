...
#if UNITY_EDITOR
public static class TConnectionsManager
{
    public static void SetAsyncConnections()
    {
        ...
        processModelSection.MaxWorkerThreads = 10;
        processModelSection.MaxIOThreads = 10;
        processModelSection.MinWorkerThreads = 5;
        processModelSection.MaxWorkerThreads = 5;
