Shader "TerraUnity/Super Shaman/Crepuscular Rays"
{
	Properties
	{
		...
		_NumSamples("Samples", Range(8, 1024)) = 128
		_Density("Density", Range(0.01, 1)) = 1.0
		_Weight("Weight", Range(0.01, 1)) = 1.0
		_Decay("Decay", Range(0.01, 1)) = 1.0
		_Exposure("Exposure", Range(0.5, 1)) = 1.0
	}
