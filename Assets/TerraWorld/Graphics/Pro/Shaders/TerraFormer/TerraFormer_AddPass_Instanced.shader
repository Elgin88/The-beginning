Shader "Hidden/TerraUnity/TerraFormer_AddPass_Instanced"
{
    ...
    SubShader
    {
        ...
        CGPROGRAM
        #pragma surface surf RealWorld vertex:SplatmapVert finalcolor:SplatmapFinalColor finalgbuffer:SplatmapFinalGBuffer decal:add fullforwardshadows //addshadow
