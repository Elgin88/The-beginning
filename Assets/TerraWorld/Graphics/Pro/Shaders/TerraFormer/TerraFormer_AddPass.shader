Shader "Hidden/TerraUnity/TerraFormer_AddPass"
{
    ...
    SubShader
    {
        ...
        CGPROGRAM
		#pragma surface surf RealWorld vertex:SplatmapVert finalcolor:SplatmapFinalColor finalgbuffer:SplatmapFinalGBuffer addshadow fullforwardshadows tessellate:tessEdge tessphong:_Phong noinstancing decal:add //nolightmap nodirlightmap nodynlightmap halfasview nometa //alpha:premul //noforwardadd
