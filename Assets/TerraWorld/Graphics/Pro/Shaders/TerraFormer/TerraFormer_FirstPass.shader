Shader "TerraUnity/TerraFormer"
{
    ...
    SubShader
	{
        ...
        CGPROGRAM
		#pragma surface surf RealWorld vertex:SplatmapVert finalcolor:SplatmapFinalColor finalgbuffer:SplatmapFinalGBuffer addshadow fullforwardshadows tessellate:tessEdge tessphong:_Phong noinstancing //nolightmap nodirlightmap nodynlightmap halfasview nometa //noforwardadd
