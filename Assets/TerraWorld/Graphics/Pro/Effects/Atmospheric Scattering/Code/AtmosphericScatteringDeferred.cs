...
namespace TerraUnity.Runtime
{
	...
	public class AtmosphericScatteringDeferred : PostEffectsBase
	{
		...
		//private static AtmosphericScatteringDeferred Script { get => GetScript(); }
		//private static AtmosphericScatteringDeferred _script;
		//
		//private static AtmosphericScatteringDeferred GetScript()
		//{
		//	return null;
		//
		//	//if (_script == null)
		//	//{
		//	//	AtmosphericScatteringDeferred script = TCameraManager.MainCamera.GetComponent<AtmosphericScatteringDeferred>();
		//	//
		//	//	if (script != null)
		//	//		_script = script;
		//	//	else
		//	//		_script = TCameraManager.MainCamera.gameObject.AddComponent<AtmosphericScatteringDeferred>();
		//	//}
		//	//
		//	//return _script;
		//}
