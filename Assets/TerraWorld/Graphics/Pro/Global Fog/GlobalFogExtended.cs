...
namespace UnityStandardAssets.ImageEffects
{
    ...
    class GlobalFogExtended : TPostEffectsBase
    {
        ...
        [Range(0.001f, 10.0f)]
        public float heightDensity = 0.001f;
        ...
        //    public float ScatteringSize = 0.999f;
        ...
        public override bool CheckResources()
        {
            ...
            if (fogShaderExtended == null) fogShaderExtended = Shader.Find("TerraUnity/Global Fog");
        ...
        void OnRenderImage(RenderTexture source, RenderTexture destination)
        {
            ...
            {
                Vector3 sundir = TTerraWorldManager.Sun.transform.forward;
                fogMaterial.SetVector("SunDir", sundir);
                //fogMaterial.SetVector("LightColor", TTerraWorldManager.SunLight.color);
            }
#else
            Vector3 sundir = RenderSettings.sun.transform.forward;
            fogMaterial.SetVector("SunDir", sundir);
