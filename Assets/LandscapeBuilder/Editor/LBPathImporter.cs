...
namespace LandscapeBuilder
{
    public class LBPathImporter : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            EditorGUILayout.HelpBox("The LB Path Importer will help you create and update Group Object Paths from an external source (e.g. EasyRoads3D)", MessageType.Info, true);
            ...
            if (landscape == null)
            {
                EditorGUILayout.HelpBox("Select a landscape to import roads to Group Object Paths", MessageType.Info, true);
            }
            else
            {
