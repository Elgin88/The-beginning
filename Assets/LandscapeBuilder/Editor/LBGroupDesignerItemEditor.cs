...
;                            };
                    ...
                    if (lbGroup != null && lbGroup.isTerrainFlattened)
                    {
                        menu.AddItem(new GUIContent("Display/Group Flatten Area"), lbGroupDesignerItem.lbGroupDesigner.showGroupFlattenArea, () =>
                        {
                            lbGroupDesignerItem.lbGroupDesigner.showGroupFlattenArea = !lbGroupDesignerItem.lbGroupDesigner.showGroupFlattenArea;
                        });
                    }
