...
namespace LandscapeBuilder
{
    ...
    public class LBTerrainTexture
    {
        ...
        public LBTerrainTexture(LBTerrainTexture lbTerrainTexture)
        {
            ...
            if (lbTerrainTexture.filterList != null) { this.filterList = LBTextureFilter.CopyList(lbTerrainTexture.filterList); }
        ...
        {
            if (terrainTexturesList == null || lbTerrainTexture == null) { return null; }
            ...
            if (texIndex >= 0) { return terrainTexturesList[texIndex].GUID; }
            else { return null; }
        }
