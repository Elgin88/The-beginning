...
namespace LandscapeBuilder
{
    ...
    public class LBFilter
    {
        ...
        /// <summary>
        /// Added 2.3.2 currently applies to FilterType.Texture
        /// with FilterMode.AND. Values below this value are considered
        /// not to be included.
        /// </summary>
        [Range(0.01f, 1f)] public float cutOff;
        ...
        public static bool Contains(List<LBFilter> lbFilterList, FilterType filterType)
        {
            ...
            {
                // Find filterType in the list.
                containsFilterType = lbFilterList.Exists(lb => lb.filterType == filterType);
            }
