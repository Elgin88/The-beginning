...
namespace LandscapeBuilder
{
    ...
    public class LBTerrainTree
    {
        ...
        /// <summary>
        /// Currently only applies when VS Pro is configured on the landscape.
        /// When enabled, user can assign any available biome to the tree.
        /// </summary>
        public bool isBiomeAssigned;
        ...
        public LBTerrainTree(LBTerrainTree lbTerrainTree)
        {
            ...
            this.isBiomeAssigned = lbTerrainTree.isBiomeAssigned;
            this.lbBiome = lbTerrainTree.lbBiome;
