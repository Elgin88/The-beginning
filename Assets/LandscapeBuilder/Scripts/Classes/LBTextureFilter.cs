...
namespace LandscapeBuilder
{
    ...
    public class LBTextureFilter
    {
        ...
        // Copy Constructor
        public LBTextureFilter(LBTextureFilter textureFilter)
        {
            ...
            {
                this.filterType = textureFilter.filterType;
                this.filterMode = textureFilter.filterMode;
                this.areaRect = new Rect(textureFilter.areaRect);
                showAreaHighlighter = false;
                this.lbStencilGUID = textureFilter.lbStencilGUID;
                this.lbStencilLayerGUID = textureFilter.lbStencilLayerGUID;
            }
        }
        ...
        /// <summary>
        /// Copies or duplicates a list of LBTextureFilters
        /// </summary>
        /// <param name="lbTextureFilterList"></param>
        /// <returns></returns>
        public static List<LBTextureFilter> CopyList(List<LBTextureFilter> lbTextureFilterList)
        {
            List<LBTextureFilter> duplicateList = new List<LBTextureFilter>();

            if (lbTextureFilterList != null && duplicateList != null)
            {
                foreach (LBTextureFilter lbFilter in lbTextureFilterList)
                {
                    if (lbFilter != null)
                    {
                        duplicateList.Add(new LBTextureFilter(lbFilter));
                    }
                }
            }
