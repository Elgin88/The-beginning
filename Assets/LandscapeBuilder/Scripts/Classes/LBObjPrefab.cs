...
namespace LandscapeBuilder
{
    ...
    public class LBObjPrefab
    {
        ...
        /// <summary>
        /// An optional array of fixed placement positions along an object path
        /// </summary>
        ...
        public LBObjPrefab(LBObjPrefab lbObjPrefab)
        {
            ...
            if (lbObjPrefab.fixedPositions == null) { fixedPositions = null; }
            else { fixedPositions = (int[])lbObjPrefab.fixedPositions.Clone(); }
        }
