...
namespace LandscapeBuilder
{
    ...
    public class LBObjPathSeries
    {
        ...
        /// <summary>
        /// Added v2.3.3. Optionally add an array of index positions where to place
        /// a main member prefab along the path. This will override the selectionMethod
        /// at that location along the path.
        /// </summary>
        public bool includeFixedPositions;
        ...
        public LBObjPathSeries(LBObjPathSeries lbObjPathSeries)
        {
            ...
            else
            {
                ...
                includeFixedPositions = lbObjPathSeries.includeFixedPositions;
