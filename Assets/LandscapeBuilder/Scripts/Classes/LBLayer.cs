...
namespace LandscapeBuilder
{
    ...
    public class LBLayer
    {
        ...
        /// <summary>
        /// How many pixels in each direction to check for an average height when repairing source image data
        /// </summary>
        [Range(3, 10)] public int pixelRangeRepairHoles;
        ...
        public LBLayer(LBLayer lbLayer)
        {
            ...
            this.pixelRangeRepairHoles = lbLayer.pixelRangeRepairHoles;
        ...
        public string ScriptLayer(int IndexID, string EndOfLineMarker = "\n")
        {
            ...
            sb.Append("\t" + layerInst + ".pixelRangeRepairHoles = " + pixelRangeRepairHoles + "; " + eol);
