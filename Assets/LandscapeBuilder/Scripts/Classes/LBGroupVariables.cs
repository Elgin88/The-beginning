...
namespace LandscapeBuilder
{
    ...
    public class LBGroupVariables
    {
        ...
        public bool isScalePrefabByOriginal;
        public float maxGroupNoPrefabTime;
        ...
        public LBGroupVariables(LBGroupParameters groupParams)
        {
            if (groupParams != null && groupParams.landscape != null)
            {
                ...
                isScalePrefabByOriginal = groupParams.landscape.isGroupScalePrefabByOriginal;
                maxGroupNoPrefabTime = groupParams.landscape.maxGroupNoPrefabTime;
